...
def objective(exp, epochs, lr, wd, phase3):
    ...
    checkpoint_path = f'/raid/NFS_SHARE/home/b.krzepkowski/Github/CLPInterventions/reports/just_run, sgd, dual_cifar10, mm_resnet_fp_0.0_lr_0.55_wd_0.0 overlap=0.0, phase3, intervention deactivation, trained with phase1=120 and phase2=200 /2023-09-08_13-59-02/checkpoints/model_step_epoch_{phase3}.pth'
    phase1 = 120
    phase2 = 200
