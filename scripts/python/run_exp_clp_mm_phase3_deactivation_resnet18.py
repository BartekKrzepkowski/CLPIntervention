...
def objective(exp, epochs, lr, wd, phase1):
    ...
    checkpoint_path = '/raid/NFS_SHARE/home/b.krzepkowski/Github/CLPInterventions/reports/deficit_reverse, sgd, dual_cifar10, mm_resnet_fp_0.0_lr_0.6_wd_0.0_window_0 overlap=0.0, phase1/2023-09-05_19-49-11/checkpoints/model_step_epoch_200_window_0.pth'
    phase2 = 0
