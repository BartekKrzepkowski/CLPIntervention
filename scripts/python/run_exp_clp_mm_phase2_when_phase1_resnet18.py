...
def objective(exp, epochs, lr, wd, phase1):
    ...
    checkpoint_path = f'/raid/NFS_SHARE/home/b.krzepkowski/Github/CLPInterventions/reports/deficit_reverse, sgd, dual_cifar10, mm_resnet_fp_0.0_lr_0.6_wd_0.0_lr_lambda_1.0_window_0 overlap=0.0, phase1/2023-09-06_16-24-21/checkpoints/model_step_epoch_{phase1}_window_0.pth'
    ...
    EXP_NAME = f'{GROUP_NAME} overlap={OVERLAP}, phase2, {quick_name}'
