...
def objective(exp, window, epochs):
    ...
    checkpoint_path = '/raid/NFS_SHARE/home/b.krzepkowski/Github/CLPInterventions/reports/just_run, sgd, dual_cifar10, mm_resnet_fp_0.0_lr_0.2_wd_0.0_window_0 overlap=0.0, phase3, intervention deactivation, trained with phase1=0 and phase2=0 /2023-08-26_02-10-22/checkpoints/model_step_epoch_200_window_0.pth'
    window1 = 0
    window2 = 0
    window3 = 200
    quick_name = f'trained with phase1={window1} and phase2={window2} and phase3={window3}'
    ...
    EXP_NAME = f'{GROUP_NAME}_window_{window} overlap={OVERLAP}, phase4, {quick_name}'
