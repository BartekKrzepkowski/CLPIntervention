...
def objective(exp, window, epochs):
    ...
    checkpoint_path = '/raid/NFS_SHARE/home/b.krzepkowski/Github/CLPInterventions/reports/deficit, sgd, dual_cifar10, dual_simple_cnn_fp_0.0_lr_0.2_wd_0.0_window_0 overlap=0.0, both enabled, checkpoint_0/2023-08-22_04-12-56/checkpoints/model_step_epoch_200_window_0.pth'
    window1 = 0
    window2 = 0
