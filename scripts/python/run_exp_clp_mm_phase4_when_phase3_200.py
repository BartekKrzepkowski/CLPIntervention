...
def objective(exp, window, epochs):
    ...
    checkpoint_path = '/raid/NFS_SHARE/home/b.krzepkowski/Github/CLPInterventions/reports/just_run, sgd, dual_cifar10, dual_simple_cnn_fp_0.0_lr_0.2_wd_0.0_window_0 overlap=0.0, both enabled, intervention deactivation, trained with phase1=160 and phase2=200 /2023-08-23_02-17-41/checkpoints/model_step_epoch_200_window_0.pth'
    window1 = 160
    window2 = 200
    window3 = 200
