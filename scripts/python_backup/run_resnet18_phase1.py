...
def objective(exp_name, phase1, lr, wd):
    ...
    T_max = batches_per_epoch * phase1
    ...
    GROUP_NAME = f'{type_names["model"]}, {type_names["dataset"]}, {type_names["optim"]}, overlap={OVERLAP}_epochs={phase1}_lr={lr}_wd={wd}_lambda={LR_LAMBDA}'
    ...
    config.exp_ends_at_epoch = phase1
...
if __name__ == "__main__":
    ...
    logging.info(f'Script started with phase1={phase1}, lr={lr}, wd={wd}')
    
    objective('phase1', phase1, lr, wd)
