...
def objective(exp_name, lr, wd, phase1, phase2, phase3, phase4):
    ...
    T_max = batches_per_epoch * (phase4 + phase3 + phase2 + phase1)
    ...
    GROUP_NAME = f'{type_names["model"]}, {type_names["dataset"]}, {type_names["optim"]}, overlap={OVERLAP}_lr={lr}_wd={wd}'
    ...
    config.phase1_starts_at_epoch = 0
    config.phase1_ends_at_epoch = phase1
    config.phase2_ends_at_epoch = phase2 + config.phase1_ends_at_epoch
    config.phase3_ends_at_epoch = phase3 + config.phase2_ends_at_epoch
    config.phase4_ends_at_epoch = phase4 + config.phase3_ends_at_epoch
...
if __name__ == "__main__":
    ...
    logging.info(f'Script started with lr={lr}, wd={wd}, phase1={phase1}, phase2={phase2}, phase3={phase3}, phase4={phase4}')
    
    objective('all_at_once', lr, wd, phase1, phase2, phase3, phase4)
