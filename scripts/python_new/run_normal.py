...
def objective(exp_name, model_name, dataset_name, lr, wd, phase2):
...
if __name__ == "__main__":
    ...
    logging.info(f'Script started model s-{conf.model_name} on dataset s-{conf.dataset_name} with lr={conf.lr}, wd={conf.wd}, epochs={conf.phase1}.')
    
    objective('phase2', conf.model_name, conf.dataset_name, conf.lr, conf.wd, conf.phase1)
