...
def objective(exp_name, model_checkpoint, phase2, lr, wd, phase1):
    ...
    config.exp_ends_at_epoch = phase2
...
if __name__ == "__main__":
    ...
    logging.info(f'Script started with phase2={phase2}, lr={lr}, wd={wd}, phase1={phase1}')
    logging.info(f'Model checkpoint path: {model_checkpoint}')
    
    objective('phase2', model_checkpoint, phase2, lr, wd, phase1)
