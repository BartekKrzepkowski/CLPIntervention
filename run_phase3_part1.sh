...
do
    ...
    echo $CHECKPOINT
    WANDB__SERVICE_WAIT=300 CUDA_VISIBLE_DEVICES=0 python -m scripts.python_new.run_phase3 model_name=mm_resnet dataset_name=mm_tinyimagenet lr=5e-1 wd=0.0 phase1=$PHASE1 phase2=$PHASE2 phase3=80 model_checkpoint="${CHECKPOINT}" &
done
