...
def get_mm_mnist(dataset_path=None, overlap=0.0, resize_factor=1/4, subset=None):
    ...
    right_transform = transforms_mnist.TRANSFORMS_NAME_MAP['transform_train_proper'](overlap, 'right')
    train_dual_augment_dataset = SplitAndAugmentDataset(train_dataset, transforms_mnist.TRANSFORMS_NAME_MAP['transform_train_proper'](overlap, 'left'), right_transform, transform3=right_transform, subset=subset, overlap=overlap, is_train=True, reverse=False)
...
def get_mm_kmnist(dataset_path=None, overlap=0.0, resize_factor=1/4, subset=None):
    ...
    right_transform = transforms_kmnist.TRANSFORMS_NAME_MAP['transform_train_proper'](overlap, 'right')
    train_dual_augment_dataset = SplitAndAugmentDataset(train_dataset, transforms_kmnist.TRANSFORMS_NAME_MAP['transform_train_proper'](overlap, 'left'), right_transform, transform3=right_transform, subset=subset, overlap=overlap, is_train=True, reverse=False)
...
def get_mm_fmnist(dataset_path=None, overlap=0.0, resize_factor=1/4, subset=None):
    ...
    right_transform = transforms_fmnist.TRANSFORMS_NAME_MAP['transform_train_proper'](overlap, 'right')
    train_dual_augment_dataset = SplitAndAugmentDataset(train_dataset, transforms_fmnist.TRANSFORMS_NAME_MAP['transform_train_proper'](overlap, 'left'), right_transform, transform3=right_transform, subset=subset, overlap=overlap, is_train=True)
...
def get_mm_svhn(dataset_path=None, overlap=0.0, resize_factor=1/4, subset=None):
    ...
    right_transform = transforms_svhn.TRANSFORMS_NAME_MAP['transform_train_proper'](overlap, 'right')
    train_dual_augment_dataset = SplitAndAugmentDataset(train_dataset, transforms_svhn.TRANSFORMS_NAME_MAP['transform_train_proper'](overlap, 'left'), right_transform, transform3=right_transform, subset=subset, overlap=overlap, is_train=True, reverse=False)
...
def get_mm_cifar10(dataset_path=None, overlap=0.0, resize_factor=1/4, subset=None):
    ...
    train_dataset = datasets.CIFAR10(dataset_path, train=True, download=DOWNLOAD)
    ...
    test_proper_dataset = datasets.CIFAR10(dataset_path, train=False, download=DOWNLOAD)
    ...
    test_blurred_dataset = datasets.CIFAR10(dataset_path, train=False, download=DOWNLOAD)
...
def get_tinyimagenet(dataset_path=None, proper_normalization=True):
...
def get_mm_tinyimagenet(dataset_path=None, overlap=0.0, resize_factor=1/4, subset=None):
    dataset_path = dataset_path if dataset_path is not None else os.environ['TINYIMAGENET_PATH']
    train_path = f'{dataset_path}/train'
    test_path = f'{dataset_path}/val'
    
    train_dataset = datasets.ImageFolder(train_path)
    right_transform = transforms_tinyimagenet.TRANSFORMS_NAME_MAP['transform_train_proper'](overlap, 'right')
    train_dual_augment_dataset = SplitAndAugmentDataset(train_dataset, transforms_tinyimagenet.TRANSFORMS_NAME_MAP['transform_train_proper'](overlap, 'left'), right_transform, transform3=right_transform, subset=subset, overlap=overlap, is_train=True)
